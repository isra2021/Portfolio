...
R_OK = str(CODE_OK) + ' ' + error_messages[CODE_OK] + EOL
R_BAD_EOL = str(BAD_EOL) + ' ' + error_messages[BAD_EOL] + EOL
R_BAD_REQUEST = str(BAD_REQUEST) + ' ' + error_messages[BAD_REQUEST] + EOL
R_INTERNAL_ERROR = str(INTERNAL_ERROR) + ' ' + \
    error_messages[INTERNAL_ERROR] + EOL
R_INVALID_COMMAND = str(INVALID_COMMAND) + ' ' + \
    error_messages[INVALID_COMMAND] + EOL
R_INVALID_ARGUMENTS = str(INVALID_ARGUMENTS) + ' ' + \
    error_messages[INVALID_ARGUMENTS] + EOL
R_FILE_NOT_FOUND = str(FILE_NOT_FOUND) + ' ' + \
    error_messages[FILE_NOT_FOUND] + EOL
R_BAD_OFFSET = str(BAD_OFFSET) + ' ' + error_messages[BAD_OFFSET] + EOL
